...
<body>
    ...
    <form id="form1" runat="server">
        <div class="upper">
            ...
            <div id="container">
                            ...
                            <td class="valign-bottom">
                                <div id="summoner_navbar" class="navbar navbar-default summoner-navbar-lol">
                                    <ul class="nav navbar-nav">
                                        <li><a id="summary_tab" href="#">Summary</a></li>
                                        <li><a id="champion_tab" href="#">Champions</a></li>
                                        <li><a id="history_tab" href="#">Match History</a></li>
                                        <li><a id="rune_tab" href="#">Runes</a></li>
                                        <li><a id="masterie_tab" href="#">Masteries</a></li>
                                    </ul>
                                </div>
                            </td>
                        </tr>
                ...
                <div id="champion_panel" runat="server" class="fullwidth panel panel_lol test">Detailed Champ Info</div>
                ...
                <%--<div class="row">
                    <div id="example_champ" runat="server" class="col-md-3 panel champ_panel">
                        <table class="fullwidth">
                            <tr>
                                <td>
                                    <div class="champ_portrait">
                                        <table class="fullwidth fullheight">
                                            <tr>
    ...
    <%--<div class="center fullwidth hide">
                    <asp:Table ID="infoTable" runat="server" EnableTheming="False" class="table champ-table"></asp:Table>
                </div>--%>
</body>
</html>
